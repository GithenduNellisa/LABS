...
class User implements Crud,Authenticator
{
	...
	public function save()
	{
		...
		$offset = $this->offset;
		$res = mysqli_query($con->conn, "INSERT INTO user(first_name,last_name,user_city,username,password,user_utc_timestamp,user_offset) VALUES('$fn','$ln','$city','$uname','$pass','$user_utc','$offset')") or die("Error" . mysqli_connect_error());
		return $res;
	}
